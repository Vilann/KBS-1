    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-12">
	      ...
	      <div class="row">
	        <div class="col-12">
			<p class="text-center text-muted font-weight-light mx-3">Algemene studentenvereniging Zwols Hoger Technisch Corps (Asv. ZHTC) is dé studentenvereniging voor iedere HBO – òf universitaire student in Zwolle.
...
Op dit moment bestaat het bestuur uit: (van links naar rechts)
– Peter Beening (secretaris)
– Bob Kiers(voorzitter)
– Gabriël Boekhold (penningmeester)
– Willemien Pilkes(vice-voorzitter) </p>
...
<a href=http://www.zhtc.nl/gilde>http://www.zhtc.nl/gilde</a>
	      ...
	      <div class="row">
	        <div class="col-12">
					<p class="text-center text-muted font-weight-light mx-3">	De initiatiefnemer voor de oprichting van de Zwolse Middelbare Technische School was Ir. F.S. Langemeijer. Hij was het die de grote vraag naar leidinggevend personeel in de regionale industrie onderkende, veroorzaakt door de naoorlogse stijging van de conjunctuur.</p>
			<p class="text-center text-muted font-weight-light mx-3">Lees <a href=https://zhtc.nl/gilde/historie/zhtc-geschiedenis>hier</a> meer over de geschiedenis van ZHTC.</p>
</div>
</div>
</div>
<div class="container-fluid">
	<div class="row">
		<div class="col-12">
			...
			<ul class="text-center text-muted font-weight-light mx-3 list-unstyled">
				...
				<li> Algemeen-secundus: Ragni Wennemers</li>
		...
		<li>Penningmeester: Hans Blom</li>
		<li>Algemeen-secundus: Martijn van der Vlag</li>
		<li>Algemeen-secundus: Olaf Brugman</li>
		<li>Algemeen-secundus: Martine van der Elsen </li>
	</ul>
